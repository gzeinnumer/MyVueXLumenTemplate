...
use App\UnitParts as CurrentModel;
...
class UnitPartsController extends Controller
{
    ...
    public function insert(Request $request)
    {
        $input = array(
            'user_login' => 'required|integer',
            'unit_part_name' => 'required|string'
        );
        ...
        if(count($checkUser)==0){
            ...
            if($validator->fails()){
                ...
                try {
                    ...
                    $model->unit_part_name = $request->unit_part_name;
    ...
    {        
        ...
        $primaryKey_value = $request->unit_part_id;
        ...
        if(count($checkUser)==0){
            ...
            if($validator->fails()){
                ...
                try {
                    $d = array(
                        'unit_part_name' => $request->unit_part_name,
